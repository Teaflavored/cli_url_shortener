...
ActiveRecord::Schema.define(version: 20141022232200) do
  ...
  add_index "taggings", ["url_id", "topic_id"], name: "index_taggings_on_url_id_and_topic_id", unique: true, using: :btree
